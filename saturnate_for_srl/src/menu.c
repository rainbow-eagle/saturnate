...
uint32_t currentBackgroundColor = GREY;
...
void displayStatistics() {
    ...
    char msg[40];
    uint32_t reservedHRAMForModels, reservedLRAMForModels, reservedHRAMForAnimations, reservedLRAMForAnimations;
    ...
    uint32_t modelHRAMUsage, modelLRAMUsage, animationHRAMUsage, animationLRAMUsage;
    ...
    const uint32_t hRAMUsagePercent = 100 * (modelHRAMUsage + animationHRAMUsage) / (reservedHRAMForModels + reservedHRAMForAnimations);
    const uint32_t lRAMUsagePercent = 100 * (modelLRAMUsage + animationLRAMUsage) / (reservedLRAMForModels + reservedLRAMForAnimations);
