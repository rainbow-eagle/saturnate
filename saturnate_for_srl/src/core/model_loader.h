 ...
 * @return int32_t The total number of meshes successfully loaded.
 * 
...
int32_t ttLoadNYAMeshes(char* fileName, PDATA* meshes, POINT* vertices, POLYGON* polygons, ATTR* attributes,
