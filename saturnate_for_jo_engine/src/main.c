...
void initSystem() {
    volatile Uint8* areaCodePtr = (Uint8*) TT_AREA_CODE_REGISTER;
...
// slPrintHex((Uint32) SortList, slLocate(2, 10));
// slPrintHex((Uint32) Zbuffer, slLocate(2, 11));
// slPrintHex((Uint32) SpriteBuf, slLocate(2, 12));
// slPrintHex((Uint32) Pbuffer, slLocate(2, 13));
// slPrintHex((Uint32) CLOfstBuf, slLocate(2, 14));
// slPrintHex((Uint32) CommandBuf, slLocate(2, 15));
